...
//                    },1000);
    ...
    activatePushNotification : function(tenantId,$http) {
		try {
            var gcmSenderID = "583836373852"; // Comment this line once we have added upgraded our platform to send push.
         ...
         PushNotification.createChannel(
           ...
           {
             id: "BeckerMigration",
             description: "BeckerBluelight Push Channel",
             importance: 1,
             vibration: true,
             sound: "default",
             visibility: 1
